  ...
  const features = [
    {
      ...
      description: "AI that knows your business and takes custom orders",
      color: "from-blue-500 to-cyan-500"
    },
    {
      icon: Globe,
      title: "Professional Website Generator",
      description: "Beautiful local shop website in 5 minutes",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            From AI-powered customer service to professional websites, we've got every aspect of your local business covered.
          </p>
        </div>
  ...
  const testimonials = [
    {
      ...
      content: "Sweet Dreams Bakery increased orders by 200% in first month. The AI assistant handles custom orders perfectly!",
      avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop&crop=face",
      rating: 5
    },
    {
      name: "James Chen",
      role: "Owner, Artisan Delights",
      content: "Setup took 5 minutes, saved me 20 hours per week. Now I can focus on creating amazing products instead of managing orders.",
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-amber-50 to-orange-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Loved by Local Shops Everywhere
          </h2>
          <p className="text-xl text-gray-600">
            See how AutoAI is transforming local shops across the country
          </p>
        </div>
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Everything you need to automate your local shop
          </p>
        </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6">
            Ready to Transform Your Local Shop?
          </h2>
          <p className="text-xl text-gray-100 mb-8 leading-relaxed">
            Join 25+ local shops already using AutoAI to increase orders, save time, and delight customers.
          </p>
          ...
          <div className="mt-8 flex flex-wrap justify-center items-center gap-6 text-gray-100">
            <div className="flex items-center gap-2">
