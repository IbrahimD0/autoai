    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="font-medium text-gray-900 dark:text-gray-100" style={{ color: "#111827" }}>Shop Assistant</h3>
            <p className="text-xs text-gray-500 dark:text-gray-400" style={{ color: "#6b7280" }}>Online now</p>
          </div>
        </div>
        <button
          onClick={onClose}
        ...
        {messages.map((message) => (
          ...
          >
            ...
            >
              ...
              style={{ color: message.sender === "user" ? "rgba(255, 255, 255, 0.7)" : "#6b7280" }}
              >
                {message.timestamp}
              </p>
            </div>
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 dark:bg-gray-800 dark:text-gray-100 bg-white text-gray-900"
          />
          <button
